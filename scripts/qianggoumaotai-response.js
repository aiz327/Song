...
async function all() {
  ...
  let seckill100012043978 = await BeginCaptcha(stop, cookiestr, initCookie);
  let specialsec = seckill100012043978 ? 'seckill100012043978='+seckill100012043978 + ';' : "";
   
  console.log("----------"+specialsec)
  seckill100012043978 = await BeginSeckill(stop, cookiestr + specialsec);
...
function BeginCaptcha(s, initCookie, cookieObj) {
  return new Promise(resolve => {
    ...
    setTimeout(() => {
      ...
      const JDBUrl = {
        url: 'https://marathon.jd.com/m/captcha.html?sid=' + cookieObj.sid + '&lat=0.000000&mid=' + cookieObj.mid + '&un_area=12_988_40034_51587&skuId=100012043978&lng=0.000000',
        headers: {
          Cookie: initCookie
        },
